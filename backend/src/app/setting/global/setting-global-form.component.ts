...
export class SettingGlobalFormComponent implements OnInit, OnDestroy {
    ...
    resetSetting() {
        ...
        this.setting.meta_attribute = '{"list":[{"value":"SAMPLE VALUE 1","label":"SAMPLE LABEL 1"}'
        ...
        _.forIn(this.form.getRawValue(), (value, key) => {
            if (typeof this.setting[key] !== 'undefined') {
                if (value instanceof moment) {
                    this.setting[key] = moment(value, environment.customDateTimeFormat.parseInput, true)
                        .format(environment.customDateTimeFormat.apiFormat);
                } else {
